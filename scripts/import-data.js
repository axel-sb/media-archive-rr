...
const sourceDb = new sqlite3.verbose().Database(SOURCE_DB_PATH, sqlite3.OPEN_READONLY, (err) => {
  if (err) {
...
async function importData() {
  try {
    ...
    // Get all media files from the attachments table
    const mediaFiles = await querySourceDb(
...
// Helper function to query the source database
function querySourceDb(query) {
